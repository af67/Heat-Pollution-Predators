...
The effects of climate change on shark behaviour and interactions with humans can be attributed to several aspects, namely temperature and sea level change, as well as GHG emissions. The statistical tests show a strong negative relationship between temperature change, sea level rise, and the annual frequency of shark attacks, while global emissions have little impact, albeit significant.
