...
```{r, echo=TRUE}
summary_table <- table(final_attacks_cleaned$Species, final_attacks_cleaned$Fatality)
...
What is the monthly distribution of shark attacks?

As illustrated in this graph, there is a tendency for shark attacks to occur more frequently during the summer months compared to the rest of the year.
