...
Another relevant information derived from this graph is the big number of unidentified sharks. Out of all the attacks recorded by our dataset, we have almost 1500 Unidentified species. It is such a pity not to be able to have this information, which would have led us to more insightful results.
...
<strong>What is the time of the year that have the most shark attacks?</strong>
