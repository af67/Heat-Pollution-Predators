...
```
-	Thanks to this correlation matrix, we can show the following main insights:
o	Sex has a slight negative correlation (-0.12) with Type.
o	There is a slight negative correlation (-0.10) between Type and Species.
o	Age has a slight negative correlation (-0.11) with Time.
o	The following variable has no significant correlation with the other numeric variables, due to the value of the coefficients close to 0: Year. 
...
5. Model with Year, Sex, Age, Species and Time: AIC = -66820.76
6. Model with Year, Sex, Age, Species, Time and Type: AIC = -66818.76
